...
function RoomManager:getImportantRooms(blacklist)
   ...
   ------------------------------------------------------------
   -- Find third maximally distant from both
   ------------------------------------------------------------
   local c
   local bestScore = -1
