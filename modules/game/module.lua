...
prism.register(prism.Component:extend "Crystal")
prism.register(prism.Component:extend "Fire")
prism.register(prism.Component:extend "Lit")
prism.register(prism.Component:extend "Snuffs")
